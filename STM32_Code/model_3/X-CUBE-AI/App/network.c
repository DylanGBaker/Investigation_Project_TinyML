...
#define AI_NETWORK_MODEL_SIGNATURE     "0x178ec8a25cdd39e81063ab280c834502"
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_flatten_input0_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    serving_default_flatten_input0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    gemm_1_output_array.data = AI_PTR(g_network_activations_map[0] + 120000);
    gemm_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 120000);
    ...
    nl_2_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 384);
    nl_2_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 384);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 961024);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 961024);
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 961152);
    gemm_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 961152);
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 969344);
    gemm_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 969344);
    gemm_3_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_weights_array.data = AI_PTR(g_network_weights_map[0] + 969600);
    gemm_3_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 969600);
    gemm_3_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_bias_array.data = AI_PTR(g_network_weights_map[0] + 970112);
    gemm_3_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 970112);
    return true;
  }
