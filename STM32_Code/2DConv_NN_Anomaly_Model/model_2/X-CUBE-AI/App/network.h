...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "cable100v2accuracy2dtflite"
...
#define AI_NETWORK_IN_1_WIDTH       (100)
#define AI_NETWORK_IN_1_CHANNEL     (3)
#define AI_NETWORK_IN_1_SIZE        (30000)
#define AI_NETWORK_IN_1_SIZE_BYTES  (120000)
