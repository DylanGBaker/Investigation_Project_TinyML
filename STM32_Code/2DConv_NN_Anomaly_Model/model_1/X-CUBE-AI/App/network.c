...
#define AI_NETWORK_MODEL_SIGNATURE     "0x02e1d091d1b0ebda7e784b2df4b04ae4"
...
#define AI_TOOLS_DATE_TIME   "Fri Oct  4 10:51:07 2024"
...
AI_LAYER_OBJ_DECLARE(
  max_pooling2d_layer, 0,
  POOL_TYPE, 0x0, NULL,
  pool, forward_mp,
  &max_pooling2d_chain,
  NULL, &conv2d_conv2d_layer, AI_STATIC, 
  .pool_size = AI_SHAPE_2D_INIT(2, 2), 
  .pool_stride = AI_SHAPE_2D_INIT(2, 2), 
  .pool_pad = AI_SHAPE_INIT(4, 0, 0, 0, 0), 
)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  &max_pooling2d_layer, 0x9331d3f2, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_0_output_array.data = AI_PTR(g_network_activations_map[0] + 170088);
    input_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 170088);
    max_pooling2d_output_array.data = AI_PTR(g_network_activations_map[0] + 290088);
    max_pooling2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 290088);
    conv2d_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 320088);
    conv2d_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 320088);
    ...
    dense_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 294912);
    dense_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 294912);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv2d_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 13824);
    conv2d_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 13824);
    dense_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 14400);
    dense_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 14336);
    dense_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 1194048);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1194048);
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 1194176);
    dense_1_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 1194176);
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 1194432);
    dense_1_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1194432);
    return true;
  }
