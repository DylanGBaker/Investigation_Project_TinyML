...
#define AI_NETWORK_MODEL_SIGNATURE     "0x2bef7bbefad2e799513993eb17d5c89b"
...
#define AI_TOOLS_DATE_TIME   "Thu Oct  3 13:06:14 2024"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, 0x0,
  AI_SHAPE_INIT(4, 30000, 32, 1, 1), AI_STRIDE_INIT(4, 1, 30000, 960000, 960000),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  8, 0x0,
  AI_SHAPE_INIT(4, 1, 30000, 1, 1), AI_STRIDE_INIT(4, 4, 4, 120000, 120000),
  1, &input_0_output_array, NULL)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 970120, 1, 1),
    970120, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 120128, 1, 1),
    120128, NULL, NULL),
  ...
  &dense_dense_layer, 0xecb4ebe5, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    dense_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 120000);
    dense_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 120000);
    ...
    dense_1_output_array.data = AI_PTR(g_network_activations_map[0] + 384);
    dense_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 384);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 1024);
    dense_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 0);
    dense_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 961024);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 961024);
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 961152);
    dense_1_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 961152);
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 969344);
    dense_1_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 969344);
    dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 969600);
    dense_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 969600);
    dense_2_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 970112);
    dense_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 970112);
    return true;
  }
