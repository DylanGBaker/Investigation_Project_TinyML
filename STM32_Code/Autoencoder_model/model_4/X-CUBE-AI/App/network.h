...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "cable_autoencodertflite"
...
#define AI_NETWORK_OUT_1_WIDTH       (32)
#define AI_NETWORK_OUT_1_CHANNEL     (3)
#define AI_NETWORK_OUT_1_SIZE        (3072)
#define AI_NETWORK_OUT_1_SIZE_BYTES  (12288)
