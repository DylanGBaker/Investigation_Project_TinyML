...
#define AI_NETWORK_DATA_ACTIVATIONS_SIZES \
  { 120128, }
#define AI_NETWORK_DATA_ACTIVATIONS_SIZE     (120128)
#define AI_NETWORK_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_DATA_ACTIVATION_1_SIZE    (120128)



#define AI_NETWORK_DATA_WEIGHTS_SIZES \
  { 489160, }
#define AI_NETWORK_DATA_WEIGHTS_SIZE         (489160)
#define AI_NETWORK_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_DATA_WEIGHT_1_SIZE        (489160)
