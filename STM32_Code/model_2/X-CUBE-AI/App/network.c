...
#define AI_TOOLS_DATE_TIME   "Thu Oct  3 17:13:28 2024"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, 0x0,
  AI_SHAPE_INIT(4, 30000, 32, 1, 1), AI_STRIDE_INIT(4, 1, 15000, 480000, 480000),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 489160, 1, 1),
    489160, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  &dense_dense_layer, 0xa7c7348c, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 64);
    dense_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 0);
    dense_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 480064);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 480064);
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 480192);
    dense_1_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 480192);
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 488384);
    dense_1_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 488384);
    dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 488640);
    dense_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 488640);
    dense_2_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 489152);
    dense_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 489152);
    return true;
  }
